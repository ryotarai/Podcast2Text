...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { name: @podcast.name, rss_url: @podcast.rss_url } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { name: @podcast.name, rss_url: @podcast.rss_url } }
